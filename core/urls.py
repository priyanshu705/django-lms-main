...
from .enhanced_views import enhanced_home_view, database_test_view


urlpatterns = [
    # Accounts url
    path("", enhanced_home_view, name="home"),
    path("db-test/", database_test_view, name="database_test"),
    path("simple/", simple_home_view, name="simple_home"),
